...
benthic_data <- read.csv("T:/Oceanography/Carbonate Budgets/NCEI/ESD_CarbBudget_Combined/ESD_CarbonateBudget_Benthic_Combined.csv", na = "", check.names = FALSE)

urchin_data <- read.csv("T:/Oceanography/Carbonate Budgets/NCEI/ESD_CarbBudget_Combined/ESD_CarbonateBudget_Urchins_Combined.csv", na = "", check.names = FALSE)
