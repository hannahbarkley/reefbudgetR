...
fish_erosion_dbase_kindinger <- calc_fish_erosion_rates(calc_kindinger_metrics_output,
...
fish_erosion_dbase_iprb <- calc_fish_erosion_rates(calc_iprb_metrics_output,
                                                    substrate_density = 1.47,
                                                    perc_day_feeding = 83.3) %>%
                                select(c(SPECIES:sizeclass), EROSION_RATE_KG_YEAR) %>%
                                separate(., sizeclass, c("PHASE", "SIZE_CLASS"), sep = "_") %>%
...
#save(fish_erosion_dbase_kindinger, file = "fish_erosion_dbase_kindinger.rda")
#save(fish_erosion_dbase_iprb, file = "fish_erosion_dbase_iprb.rda")
